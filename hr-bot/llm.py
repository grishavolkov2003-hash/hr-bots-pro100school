...
- Помочь с назначением собесов (показать слоты кандидатов)
- Показать скоринг кандидатов

Отвечай коротко, структурированно. Если спрашивают сводку — дай таблицу. Если про конкретного человека — дай всю инфу включая скор и слоты.
...
def get_manager_response(question, all_candidates):
    ...
    for c in all_candidates:
        ...
        candidates_summary.append(
            ...
            f"Комментарий: {c.get('comment', '')} | Слоты: {c.get('slots', '')} | "
